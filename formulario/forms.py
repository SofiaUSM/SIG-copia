...
class CrearFormulario(forms.Form):
    ...
    corre_solicitante = forms.CharField(label ="Correo del solicitante",max_length=255, widget=forms.TextInput(attrs={'class': 'form-control '}))
    ...
    insumo = forms.CharField(label ="Insumo solicitado y formato(EXCEL, Desarrollo Arcgis Online, Formulario Digital, Cuadro de Mando,Mapa web, Aplicacion web, y otros herramientas territoriales previas a la reunión)\n"
